...
export function startNFTEvents(): void {

    console.log(
        "NFT Event Listener Started"
    );
        ...
        async (
            ...
            try {
                ...
                if (processed) {
                    ...
                    console.log(
                        `[EVENT] NFTMinted duplicate skipped: ${transactionHash}:${logIndex}`
                    );
                ...
                console.log(
                    "NFT + Transaction saved to MySQL"
                );
