...
import { createAuctionValidator, updateAuctionValidator, auctionIdValidator, auctionNFTIdValidator, placeBidValidator, auctionQueryValidator } from "../validators/auction.validator.js";
...
// ==========================================================
// Get all auctions
router.get("/", auctionQueryValidator, AuctionController.getAllAuctions);
// Get active auctions
...
// Update auction
router.patch("/:id", authenticate, updateAuctionValidator, AuctionController.updateAuction);
// Cancel auction
...
// Place bid
router.post("/:id/bids", authenticate, placeBidValidator, AuctionController.placeBid);
