...
export class AuctionController {
    ...
    static createAuction = asyncHandler(async (req, res) => {
        ...
        const id = await AuctionService.createAuction(seller, req.body);
    ...
    // Place Bid
    // ==========================================================
    static placeBid = asyncHandler(async (req, res) => {
        const bidder = req.user.wallet;
        const id = Number(req.params.id);
        const bidAmount = Number(req.body.bid_amount);
        await AuctionService.updateHighestBid(id, bidder, bidAmount);
        return ApiResponse.success(res, "Bid placed successfully");
    });
}
